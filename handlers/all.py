...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("المطور", url="t.me/IM_KI")],[InlineKeyboardButton("تواصل المطور", url="t.me/IM_KI")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/IM_KI")]])
