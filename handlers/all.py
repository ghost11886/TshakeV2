...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if text == "كت تويت" or text == "كت اتويت" or text == "كت":
      texting = ["آخر مرة زرت مدينة الملاهي؟","آخر مرة أكلت أكلتك المفضّلة؟","الوضع الحالي؟\n‏1. سهران\n‏2. ضايج\n‏3. أتأمل","آخر شيء ضاع منك؟","كلمة أخيرة لشاغل البال؟","طريقتك المعتادة في التخلّص من الطاقة السلبية؟","شهر من أشهر العام له ذكرى جميلة معك؟","كلمة غريبة من لهجتك ومعناها؟🤓","‏- شيء سمعته عالق في ذهنك هاليومين؟","متى تكره الشخص الذي أمامك حتى لو كنت مِن أشد معجبينه؟","‏- أبرز صفة حسنة في صديقك المقرب؟","هل تشعر أن هنالك مَن يُحبك؟","اذا اكتشفت أن أعز أصدقائك يضمر لك السوء، موقفك الصريح؟","أجمل شيء حصل معك خلال هاليوم؟","صِف شعورك وأنت تُحب شخص يُحب غيرك؟👀💔","كلمة لشخص غالي اشتقت إليه؟💕","آخر خبر سعيد، متى وصلك؟","أنا آسف على ....؟","أوصف نفسك بكلمة؟","صريح، مشتاق؟","‏- صريح، هل سبق وخذلت أحدهم ولو عن غير قصد؟","‏- ماذا ستختار من الكلمات لتعبر لنا عن حياتك التي عشتها الى الآن؟💭","‏- فنان/ة تود لو يدعوكَ على مائدة عشاء؟😁❤","‏- تخيّل شيء قد يحدث في المستقبل؟","‏- للشباب | آخر مرة وصلك غزل من فتاة؟🌚","شخص أو صاحب عوضك ونساك مُر الحياة ما اسمه ؟","| اذا شفت حد واعجبك وعندك الجرأه انك تروح وتتعرف عليه ، مقدمة الحديث شو راح تكون ؟.","الفلوس او الحب ؟","نظرتك لمشاهير التيك توك؟","كم لعبة في هاتفك، وما أفضلهم؟","الحياة في كلمتين؟","أجمل الأسماء واقربها لقلبك؟","كيف قضيت أسبوعك؟","صريح، تؤمن بصداقات مواقع التواصل؟","رأيك بالإنسان الغامض؟","أيهما أهم بالنسبة لك؟ أن يحبك الناس أم يفهموك؟","لا يوجد إنسان لم يهزه الفشل.. تتفق؟","لا يوجد شخص رائع على طول صح او خطأ؟","بيت شعر عالق في ذهنك؟","صفة سيئة في مجتمعاتنا تتمنى زوالها؟","لفوضوية أم المرتبة والمنظمة؟بالون التفكير"]  
      randomresponse2 = random.choice(texting)
      Bot("sendMessage",{"chat_id":chatID,"text":randomresponse2,"reply_to_message_id":message.message_id,"parse_mode":"html","disable_web_page_preview":True})
